...
// Get the HTML canvas by its id 
plots = document.getElementById("pies2");
// Example datasets for X and Y-axes 
var conexao = ["Conectado", "+10min off", "Desconectado"]; //Stays on the X-axis 
var traffic = [277, 98, 27] //Stays on the Y-axis 
// Create an instance of Chart object:
new Chart(plots, {
 type: 'pie', //Declare the chart type
 data: {
 labels: conexao, //Defines each segment
 datasets: [{
 data: traffic, //Determines segment size
 //Color of each segment
 backgroundColor: [
